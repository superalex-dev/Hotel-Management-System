...
namespace HotelManagementSystem.Controllers
{
    public class RoomsController : Controller
    {
        ...
        {
            var hotelManagementSystemContext = _context.Rooms.Include(r => r.RoomType);
        ...
        public async Task<IActionResult> Create([Bind("RoomId,RoomNumber,RoomTypeId,Status")] Room room)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("RoomId,RoomNumber,RoomTypeId,Status")] Room room)
        {
            if (id != room.RoomId)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'HotelManagementSystemContext.Rooms'  is null.");
            }
            var room = await _context.Rooms.FindAsync(id);
            if (room != null)
            {
