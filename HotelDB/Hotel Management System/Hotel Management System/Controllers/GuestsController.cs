    ...
    public class GuestsController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Guests != null ? 
                          ...
                          Problem("Entity set 'HotelDBContext.Guests'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("GuestId,Name,Phone,Email,Address")] Guest guest)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("GuestId,Name,Phone,Email,Address")] Guest guest)
        {
            if (id != guest.GuestId)
            {
                return NotFound();
