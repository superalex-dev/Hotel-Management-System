...
namespace HotelDB.Controllers
{
    public class PaymentsController : Controller
    {
        ...
        {
            var hotelManagementContext = _context.Payments.Include(p => p.Booking);
        ...
        public async Task<IActionResult> Create([Bind("PaymentID,BookingID,PaymentMethod,PaymentDate,Amount")] Payment payment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PaymentID,BookingID,PaymentMethod,PaymentDate,Amount")] Payment payment)
        {
