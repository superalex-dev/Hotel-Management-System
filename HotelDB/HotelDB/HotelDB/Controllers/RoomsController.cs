...
namespace HotelDB.Controllers
{
    public class RoomsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("RoomID,HotelID,RoomNumber,RoomType,Price,Available")] Room room)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("RoomID,HotelID,RoomNumber,RoomType,Price,Available")] Room room)
        {
            if (id != room.RoomID)
            {
                return NotFound();
